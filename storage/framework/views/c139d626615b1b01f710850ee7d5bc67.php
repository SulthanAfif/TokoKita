...
<div class="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    <?php $__currentLoopData = [
        ...
        ['label' => 'Produk Terjual', 'value' => number_format($stats['products_sold'], 0, ',', '.') . ' unit', 'sub' => 'Semua customer', 'color' => 'bg-emerald-50 text-emerald-600', 'icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\proyekporto\project\TokoKita\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>