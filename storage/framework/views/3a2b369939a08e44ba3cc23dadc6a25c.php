<?php $__env->startSection('title', 'Pesanan ' . $order->order_number); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl">
    <div class="mb-6">
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-slate-500 hover:text-indigo-600 transition">← Kembali</a>
        <div class="flex flex-wrap items-center gap-3 mt-2">
            <h2 class="text-lg font-semibold text-slate-800"><?php echo e($order->order_number); ?></h2>
            <?php
                $statusColors = [
            ...
            ?>
            <span class="px-2.5 py-0.5 rounded-full text-xs font-medium capitalize <?php echo e($statusColors[$order->status] ?? 'bg-slate-100'); ?>">
                <?php echo e($order->status); ?>

            </span>
        </div>
        <p class="text-sm text-slate-500 mt-1">
            <?php echo e($order->user->name ?? '-'); ?> · <?php echo e($order->created_at->format('d M Y, H:i')); ?>

        </p>
    </div>

    <?php if($order->status === 'paid' && $order->paid_at): ?>
    <div class="rounded-2xl border border-green-200 bg-green-50 p-4 mb-5 text-sm text-green-800">
        ...
        <p>Customer membayar pada <?php echo e($order->paid_at->format('d M Y, H:i')); ?>. Silakan proses pesanan.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 mb-5">
        ...
        <form action="<?php echo e(route('admin.orders.updateStatus', $order)); ?>" method="POST" class="flex flex-wrap items-end gap-3">
            <?php echo csrf_field(); ?>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 mb-5">
        ...
        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex justify-between text-sm mb-2">
                <span class="text-slate-600"><?php echo e($item->product_name); ?> × <?php echo e($item->quantity); ?></span>
        ...
        <p class="text-xs text-slate-400 mt-2">
            Pembayaran: <?php echo e($payLabels[$order->payment_method] ?? ($order->payment_method ?? '-')); ?>

            <?php if($order->paid_at): ?>
                · Dibayar: <?php echo e($order->paid_at->format('d M Y H:i')); ?>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <p class="text-sm text-slate-600">
            <?php echo e($order->address->recipient_name); ?> · <?php echo e($order->address->phone); ?><br>
            <?php echo e($order->address->full_address); ?>, <?php echo e($order->address->city); ?>, <?php echo e($order->address->province); ?> <?php echo e($order->address->postal_code); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\proyekporto\project\TokoKita\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>