...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — TokoKita Admin</title>
...
<div class="min-h-screen flex">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto" @click="if ($event.target.closest('a')) sidebarOpen = false">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.products.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.categories.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.stock.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.stock.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.pages.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.pages.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.settings.edit')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="<?php echo e(route('admin.hero-slides.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                      <?php echo e(request()->routeIs('admin.hero-slides.*') ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        <div class="px-4 py-4 border-t border-slate-700/60 shrink-0">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[11px] text-slate-400 truncate"><?php echo e(auth()->user()->email); ?></p>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col min-w-0 w-full max-w-full">
        ...
        <header class="sticky top-0 z-30 h-16 bg-white border-b border-slate-200 flex items-center px-4 sm:px-6 gap-4">
            ...
            <h1 class="text-lg font-semibold text-slate-800 truncate"><?php echo $__env->yieldContent('title', 'Admin'); ?></h1>
...
<?php /**PATH C:\proyekporto\project\TokoKita\resources\views/layouts/admin.blade.php ENDPATH**/ ?>