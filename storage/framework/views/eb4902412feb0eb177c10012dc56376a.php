...
<?php if($cart->items->isEmpty()): ?>
    <div class="text-center py-20">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="text-indigo-600 font-medium hover:text-indigo-500">Mulai belanja →</a>
    </div>
<?php else: ?>
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4">
                <div class="w-20 h-20 rounded-xl bg-slate-100 overflow-hidden flex-shrink-0">
                    <?php if($item->product->thumbnail): ?>
                        <img src="<?php echo e($item->product->thumbnail_url); ?>" class="w-full h-full object-cover" alt="">
                    <?php endif; ?>
                </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-indigo-600 font-bold text-sm mt-1">
                        Rp<?php echo e(number_format($item->product->final_price, 0, ',', '.')); ?>
                ...
                <form action="<?php echo e(route('cart.update', $item->id)); ?>" method="POST" class="flex items-center gap-1">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 h-fit sticky top-24">
        ...
        <div class="flex justify-between text-sm mb-1">
            <span class="text-slate-500">Subtotal (<?php echo e($cart->items->sum('quantity')); ?> item)</span>
            <span class="font-semibold">Rp<?php echo e(number_format($cart->total, 0, ',', '.')); ?></span>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\proyekporto\project\TokoKita\resources\views/cart/index.blade.php ENDPATH**/ ?>